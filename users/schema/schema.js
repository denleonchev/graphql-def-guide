...
const RootQuery = new GraphQLObjectType({
    ...
    fields: {
        ...
        company: {
            ...
            resolve(parentValue, args) {
                return axios.get(`http://localhost:80811/companies/${args.id}`).then(resp => resp.data)
            }
        }
    }
})
    ...
    fields: {
        ...
        deleteUser: {
            ...
            resolve(parentValue, { id }) {
                return axios.delete(`http://localhost:8081/users/${id}`).then(resp => resp.data)
            }
        ...
        editUser: {
            ...
            resolve(parentValue, args) {
                return axios.patch(`http://localhost:8081/users/${args.id}`, args).then(resp => resp.data)
            }
